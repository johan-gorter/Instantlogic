...
public class DeductionSchemeFlow extends org.instantlogic.interaction.flow.impl.SimpleFlow {

	public static final DeductionSchemeFlow INSTANCE = new DeductionSchemeFlow();
	...
	private static final org.instantlogic.interaction.flow.FlowNodeBase[] NODES = new org.instantlogic.interaction.flow.FlowNodeBase[]{
		org.instantlogic.designer.flow.deductionscheme.DeductionSchemePlaceTemplate.INSTANCE,
	};
