...
public class EntityContextPageFragment extends org.instantlogic.interaction.page.SharedElement {
    ...
    new org.instantlogic.interaction.page.FragmentTemplate("Fragmnttmpltdsgn__0047", "Group")        
        .addChild("content",
            ...
            new org.instantlogic.interaction.page.FragmentTemplate("Fragmnttmpltdsgn__0048", "Link")      
                ...
                .addChild("content",
                    new org.instantlogic.interaction.page.FragmentTemplate("Fragmnttmpltdsgn__0049", "Block")      
                        ...
                        .addChild("content",
                            new org.instantlogic.interaction.page.FragmentTemplate("Fragmnttmpltdsgn__004a", "Heading3")      
