...
import org.instantlogic.designer.IfElseDesignEntityGenerator;
import org.instantlogic.designer.PropertyDesignEntityGenerator;
import org.instantlogic.designer.SelectionDesign;
import org.instantlogic.designer.SelectionDesignEntityGenerator;
...
public class ElementEditorSharedElementGenerator extends SharedElementDefinitionDesign {
	...
	@Override
	public void init() {
		DeductionSchemeDesign fragmentType, propertyName, editorOpen1, editorOpen2, hasAttribute, previewMode, previewMode2, previewMode3, entityHasValue;
		SelectionDesign asFragmentTemplate, asIfElse, asSelection, selectProperties, selectPropertyChildren;
					...
					asFragmentTemplate = new SelectionDesign()
						.setChild(
							new FragmentTemplateDesign("Block")
								.setChildren("content", 
									new IfElseDesign().setCondition(editorOpen1 = new DeductionSchemeDesign())
										.setIfChild( // Editor
											new FragmentTemplateDesign("Block")
	...
	//														)
						...
						asIfElse = new SelectionDesign()
							.setChild(new FragmentTemplateDesign("Block").addToStyleNames("collapsable-content")
								.setChildren("content",
									new FragmentTemplateDesign("Link").addToStyleNames("collapse-button")
										.setChildren("content", new FragmentTemplateDesign("Icon").addToStyleNames("icon-chevron-down")),
									new FragmentTemplateDesign("PreviewLine")
										.setValue("previewMode", previewMode2 = new DeductionSchemeDesign())
										.setChildren("content", 
											new FragmentTemplateDesign("Strong")
												.setText("text", createConstantText("[IfElse]"))
										)
								)
							),
						asSelection = new SelectionDesign()
							.setChild(new FragmentTemplateDesign("Block").addToStyleNames("collapsable-content")
								.setChildren("content",
									new FragmentTemplateDesign("Link").addToStyleNames("collapse-button")
										.setChildren("content", new FragmentTemplateDesign("Icon").addToStyleNames("icon-chevron-down")),
									new FragmentTemplateDesign("PreviewLine")
										.setValue("previewMode", previewMode3 = new DeductionSchemeDesign())
										.setChildren("content", 
											new FragmentTemplateDesign("Strong")
												.setText("text", createConstantText("[Selection]"))
										)
								)
							)
				)
		...
		asIfElse.newSelection()
			.deduceCastInstance(asIfElse.getSelection()
				.deduceSelectedInstance(ElementDesignEntityGenerator.ENTITY), IfElseDesignEntityGenerator.ENTITY);
		asSelection.newSelection()
			.deduceCastInstance(asSelection.getSelection()
					.deduceSelectedInstance(ElementDesignEntityGenerator.ENTITY), SelectionDesignEntityGenerator.ENTITY);
		...
		previewMode2.deduceAttribute(ElementDesignEntityGenerator.previewMode);
		previewMode3.deduceAttribute(ElementDesignEntityGenerator.previewMode);
